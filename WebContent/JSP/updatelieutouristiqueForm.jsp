...
<head>
    ...
    <!-- Title Page-->
    <title>Update Lieu Touristique Form</title>
...
String IDRes = request.getParameter("idLT");
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Restaurant
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editlieutouristique.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(lieutouristique.class , idReserv);
                                            	
                                            	lieutouristique res = (lieutouristique) ob;
                                            ...
                                            <input type="hidden" name="idLieuTourUpdate" value="<%=res.getIdLT() %>" class="form-control">
                                            
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Type Lieu Touristique :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="typeLieuTourUpdate" value="<%=res.getTypeLT() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Description Lieu Touristique :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="descLTUpdate" value="<%=res.getDescriptionLT() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Nom Lieu Touristique :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="nomLTUpdate" value="<%=res.getNomLT() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Adresse Lieu Touristique :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="adresseLTUpdate" value="<%=res.getAdresseLT() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">ID Ville Lieu Touristique :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="idVilleLTUpdate" value="<%=res.getIdVilleLT() %>" class="form-control">
