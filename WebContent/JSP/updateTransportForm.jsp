...
<head>
    ...
    <!-- Title Page-->
    <title>Update Transport Form</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Transport
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editTransport.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(transport.class , idReserv);
                                            	
                                            	transport res = (transport) ob;
                                            ...
                                            <input type="hidden" name="idTransportUpdate" value="<%=res.getIdT() %>" class="form-control">
                                            
                                            
                                                <div class="col col-md-3">
                                                    <label for="typeTransport" class=" form-control-label">Type Transport :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="typeTransport" name="typeTransportUpdate" value="<%=res.getTypeT() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer l'adresse du Transport</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Nombre de Place Transport :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" min="1" name="nbrPlaceTransportUpdate" value="<%=res.getNbrPlaceT() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer le nombre de place du Transport</small>
                                                </div>
                                            </div>
