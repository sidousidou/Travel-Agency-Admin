                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="editReservation.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(reservation.class , idReserv);
                                            	
                                            	reservation res = (reservation) ob;
                                            ...
                                            <input type="hidden" name="idReservUpdate" value="<%=res.getIdR() %>" class="form-control">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <input type="date" name="dateReservUpdate" value="<%=res.getDateR() %>" class="form-control">
                                            ...
                                            <%-- <%} %> --%>
                                             ...
                                             <%-- <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="montant-paye" value="<%=res.getDateR() %>" class="form-control">
                                             ...
                                             <div class="row form-group" >
                                                ...
                                                <label class=" form-control-label">Montant Paye :  </label>
                                                    ...
                                                    <div class="input-group col-12 col-md-9">
                                                        ...
                                                        <input type="text" name="montantPayeUpdate" value="<%=res.getMontantPayeR() %>" class="form-control">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="idUserResUpdate" value="<%=res.getIdUser() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer l'Id d'utilisateur</small>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="codeVoyageResUpdate" value="<%=res.getCodeVoyR() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="codeVTResUpdate" value="<%=res.getCodeVTR() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="idActResUpdate" value="<%=res.getIdActR() %>" class="form-control">
