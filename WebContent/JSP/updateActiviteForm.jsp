...
<head>
    ...
    <!-- Title Page-->
    <title>Update Activite Form</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Activite
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editActivite.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(activite.class , idC);
                                            	
                                            	activite h = (activite) ob;
                                            ...
                                            <input type="hidden" name="idActiviteUpdate" value="<%=h.getIdA() %>" class="form-control">
                                            
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Type Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="typeActiviteUpdate" value="<%=h.getTypeA() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Description Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="descActiviteUpdate" value="<%=h.getDescriptionA() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">ID Ville Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="idVilleActiviteUpdate" value="<%=h.getIdVilleA() %>" class="form-control">
