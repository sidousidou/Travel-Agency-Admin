...
<head>
    ...
    <!-- Title Page-->
    <title>Update Voyage Form</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Voyage
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editVoyage.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(voyage.class , idReserv);
                                            	
                                            	voyage res = (voyage) ob;
                                            ...
                                            <input type="hidden" name="codeVoyUpdate" value="<%=res.getCodeV() %>" class="form-control">
                                            
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Date Debut du Voyage :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="date" name="dateDVUpdate" value="<%=res.getDateDebutV() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Date Fin du Voyage :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="date" name="dateFVUpdate" value="<%=res.getDateFinV() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">ID Utilisateur Voyage :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="IDUVUpdate" value="<%=res.getIdUserVoy() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Code Circuit Voyage :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="codeCircVoyageUpdate" value="<%=res.getCodeCircuitV() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">ID Ville Voyage :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="idVilleVoyageUpdate" value="<%=res.getIdVilleV() %>" class="form-control">
