                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Ville
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editVille.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(ville.class , idC);
                                            ...
                                            %>
                                                ...
                                                <input type="hidden" name="idVilleUpdate" value="<%=h.getIdVille() %>" class="form-control">
                                                
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Nom Ville :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="nomVilleUpdate" value="<%=h.getNomV() %>" class="form-control">
