                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="editRestaurant.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(restaurant.class , idReserv);
                                            	
                                            	restaurant res = (restaurant) ob;
                                            ...
                                            <input type="hidden" name="idRestaurantUpdate" value="<%=res.getIdRes() %>" class="form-control">
                                            
                                            
                                            
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Adresse Restaurant :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="adresseRestaurantUpdate" value="<%=res.getAdresseR() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer l'adresse du Restaurant</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="numTelRestaurantUpdate" value="<%=res.getNumTeleR() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer le Numero de Telephone du Restaurant</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Classement du Restaurant :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" min="1" max="5" name="classementRestaurantUpdate" value="<%=res.getClassementR() %>" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer la classement du Restaurant </small>
                                                </div>
                                            </div>
