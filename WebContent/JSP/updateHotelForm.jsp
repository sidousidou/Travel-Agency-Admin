...
int idHo = Integer.parseInt(IDHotel);
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Update Reservation
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="editHotel.jsp" method="get" role="form" > <!-- enctype="multipart/form-data" class="form-horizontal"> -->
                                            ...
                                            try{
                                            	...
                                            	Object ob = sess.load(hotel.class , idHo);
                                            ...
                                            <input type="hidden" name="idHotelUpdate" value="<%=h.getIdH() %>" class="form-control">
                                            
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Adresse Hotel :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="adresseHotelUpdate" value="<%=h.getAdresseH() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="nbrChambreHUpdate" value="<%=h.getNbrChambreH() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="numTelHotelUpdate" value="<%=h.getNumTeleH() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Classement de l'Hotel :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" min="1" max="5" name="classementHotelUpdate" value="<%=h.getClassementH() %>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Site Web de l'Hotel :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="siteWebHotelUpdate" value="<%=h.getSiteWebH() %>" class="form-control">
