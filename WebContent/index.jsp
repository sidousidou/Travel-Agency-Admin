...
<div class="super_container">
					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="about.jsp" target="_blank">About us</a></li>
								<li class="main_nav_item"><a href="offers.jsp" target="_blank">Offers</a></li>
								<li class="main_nav_item"><a href="news.jsp" target="_blank">News</a></li>
								<li class="main_nav_item"><a href="Login.jsp" target="_blank">sign in</a></li>
							</ul>
						</nav>
						<!--sign in -->
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				...
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="offers.jsp">Offers</a></li>
					<li class="menu_item menu_mm"><a href="news.jsp">News</a></li>
	...
	<div class="home">
		<div class="home_background" style="background-image:url(images/beach-golden-hour-grass-1192671.jpg)"></div>
		<div class="home_content">
			<div class="home_content_inner">
				<div class="home_text_large">Discover DZ </div>
		...
		<div class="container">
			...
			<div class="row top_content">
				...
				<div class="col-lg-3 col-md-6 top_col">
					...
					<div class="top_item">
						<a href="offers.jsp">
							<div class="top_item_image"><img src="images/beach-clouds-dawn-262325.jpg" alt="https://unsplash.com/@sgabriel"></div>
							<div class="top_item_content">
								<div class="top_item_price"></div>
								<div class="top_item_text">bejaia, Algeira</div>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="top_item">
						<a href="offers.jsp">
							<div class="top_item_image"><img src="images/high-landscape-majestic-1183021.jpg" alt="https://unsplash.com/@jenspeter"></div>
							<div class="top_item_content">
								<div class="top_item_price"></div>
								<div class="top_item_text">Djijel, Algeira</div>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 top_col">
					...
					<!-- Top Destination Item -->
				 	<div class="top_item">
						<a href="offers.jsp">
							<div class="top_item_image"><img src="images/4x4-desert-dunes-69797.jpg" alt="https://unsplash.com/@anikindimitry"></div>
							<div class="top_item_content">
								<div class="top_item_price"></div>
								<div class="top_item_text">Djanet ,Algeira</div>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 top_col">
					...
					<!-- Top Destination Item -->
					  <div class="top_item">
						<a href="offers.jsp">
							<div class="top_item_image"><img src="images/arizona-clouds-dawn-248174.jpg" alt="https://unsplash.com/@hellolightbulb"></div>
							<div class="top_item_content">
								<div class="top_item_price"></div>
								<div class="top_item_text">Tamanrasset, Algeria</div>
							</div>
						</a>	
					</div>
				...
				<div class="col-lg-6 last_col">
					<div class="last_item">
						<div class="last_item_content">
							<div class="last_subtitle">Djanet</div>
							<div class="last_percent">50%</div>
							<div class="last_title">Last Minute Offer</div>
							<div class="last_text"></div>
							<div class="button last_button"><a href="offers.jsp">See Offer</a></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 last_col">
					<div class="last_item">
						<div class="last_item_content">
							<div class="last_subtitle">Bejaia</div>
					...
					<div class="popular_content d-flex flex-md-row flex-column flex-wrap align-items-md-center align-items-start justify-content-md-between justify-content-start">
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									...
									<div class="popular_item_title">Sahra</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Jijel</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Oran</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Skikda</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Chlef</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Annaba</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Djorjora</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.jsp">
								...
								<div class="popular_item_content">
									<div class="popular_item_price"></div>
									<div class="popular_item_title">Mostghenem</div>
								</div>
							</a>
						</div>
			...
			<div class="special_slider_container">
				...
				<!--  <div class="owl-item">
						<div class="special_item">
							<div class="special_item_background"><img src="images/IMGP0055.jpg" alt="https://unsplash.com/@garciasaldana_"></div>
 ...
 -->
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							<div class="special_item_background"><img src="images/depositphotos_5479314-stock-photo-city-of-constantine-algeria.jpg" alt="https://unsplash.com/@varshesh"></div>
							<div class="special_item_content text-center">
								<div class="special_category">Culture</div>
								<div class="special_title"><a href="offers.jsp">Constantine</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							<div class="special_item_background"><img src="images/téléchargement.jpg" alt="https://unsplash.com/@paulgilmore_"></div>
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers.jsp">Tlemcen</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							<div class="special_item_background"><img src="images/d70bb9847f4336109bcfbb73863ecdb7.jpg" alt="https://unsplash.com/@hellolightbulb"></div>
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers.jsp">Tamenrasset</a></div>
							</div>
						</div>
					</div>
					...
					<div class="owl-item">
						<div class="special_item d-flex flex-column align-items-center justify-content-center">
							<div class="special_item_background"><img src="images/7f8dab091d6fb628187acf210fa2592f.jpg" alt="https://unsplash.com/@dnevozhai"></div>
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers.jsp">Djanet</a></div>
							</div>
						</div>
					</div>
