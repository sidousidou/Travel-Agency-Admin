					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Voyages table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addVoyageForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add voyage
											</button>
										</a>
									...
									<table class="table table-data2">
										<thead>
											<tr>
												...
												<th>Code Voyage</th>
												<th>Date Debut Voyage</th>
												<th>Date Fin Voyage</th>
												<th>ID Utilisateur Voyage</th>
												<th>Code Circuit Voyage</th>
												<th>ID Ville Voyage</th>
                                        ...
                                        List voyage = sess.createQuery("From voyage").list();
                                        
                                        
                                        for(Iterator iterator = voyage.iterator(); iterator.hasNext();){
                                        
                                        	voyage r = (voyage) iterator.next();
                                        ...
                                        %>
                                            <tr class="tr-shadow">
                                                <td>
													...
													<td>
                                                <span> <%= r.getCodeV() %> </span>
                                                </td> 
													
                                             
                                                	
                                                	
                                                	<td> <%= r.getDateDebutV() %></td>
                                                	
                                                    <td> <%= r.getDateFinV() %></td>
                                                
                            
                                                <td>
                                                <span><%= r.getIdUserVoy() %></span>
                                                </td>
                                                
                                                <td>
                                                <span> <%= r.getCodeCircuitV() %> </span>
                                                </td> 
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateVoyageForm.jsp?codeV=<%= r.getCodeV() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Edit">
                                                            <i
																class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="../JSP/deleteVoyage.jsp?codeV=<%= r.getCodeV() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
