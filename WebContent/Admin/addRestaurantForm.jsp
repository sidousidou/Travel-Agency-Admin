                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Add Restaurant
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="../JSP/addRestaurant.jsp" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="adresseRestaurant" placeholder="Adresse Restaurant" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="numTelRestaurant" placeholder="Numero de Telephone du Restaurant " class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" min="1" max="5" name="classementRestaurant" placeholder="Classement du Restaurant" class="form-control">
