                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Add Ville
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="../JSP/addVille.jsp" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <!-- <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="idVille" class=" form-control-label">ID Ville :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="idVille" name="idVille" placeholder="ID Ville" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer l'ID du Ville</small>
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="nomVille" class=" form-control-label">Nom Ville :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nomVille" name="nomVille" placeholder="Nom de la Ville" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer le nom de la ville</small>
                                                </div>
                                            </div>
