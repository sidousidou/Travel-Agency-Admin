							...
							<div class="col-md-12">
								...
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addRestaurantForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add restaurant
											</button>
										</a>
								...
								<div class="table-responsive table-responsive-data2">
									<table class="table table-data2">
                                        ...
                                        List restaurant = sess.createQuery("From restaurant").list();
                                        
                                        
                                        for(Iterator iterator = restaurant.iterator(); iterator.hasNext();){
                                        ...
                                        %>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <span> <%= r.getNumTeleR() %> </span>
                                                </td> 
                                                
                                                <td>
                                                <span> <%= r.getClassementR() %> </span>
                                                </td> 
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateRestaurantForm.jsp?idR=<%= r.getIdRes() %>">
                                                        <button
                                                        ...
                                                        <a href="../JSP/deleteRestaurant.jsp?idR=<%= r.getIdRes() %>">
                                                        <button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
