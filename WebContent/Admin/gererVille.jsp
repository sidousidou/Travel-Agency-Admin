					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Villes table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addVilleForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add ville
											</button>
										</a>
								...
								<div class="table-responsive table-responsive-data">
									<table class="table table-data2">
                                        ...
                                        List ville = sess.createQuery("From ville").list();
                                        
                                        
                                        for(Iterator iterator = ville.iterator(); iterator.hasNext();){
                                        
                                        	ville h = (ville) iterator.next();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateVilleForm.jsp?idVille=<%= h.getIdVille() %>"><button
                                                        ...
                                                        <a href="../JSP/deleteVille.jsp?idVille=<%= h.getIdVille() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
