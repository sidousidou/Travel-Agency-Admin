...
<head>
    ...
    <!-- Title Page-->
    <title>Add Transport Form</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Add Transport
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="../JSP/addTransport.jsp" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Type Transport :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="typeTransport" placeholder="Type du Transport" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="nbrPlaceTransport" class=" form-control-label">Nombre de Place Transport :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" min="1" id="nbrPlaceTransport" name="nbrPlaceTransport" placeholder="Nombre de place du Transport" class="form-control">
