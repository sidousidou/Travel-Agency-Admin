...
%>
	<div class="page-wrapper">
			...
			<div class="header-mobile__bar">
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="Admin/index.jsp"> <img
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="Admin/index.jsp"> <img src="images/icon/logo.png"
					alt="Cool Admin" />
				</a>
			</div>
							...
							<div class="col-md-12">
							 ...
							 <%-- <%
							  ...
							  <%-- <%
								...
								String typeU = resultSet.getString("typeU");
								String nomU = resultSet.getString("nomU");
								String emailU = resultSet.getString("emailU");
								String motDePasseU = resultSet.getString("motDePasseU");*/
								...
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addUserBtn" href="addUserForm.jsp">
								...
								<div class="table-responsive table-responsive-data2">
								    ...
								    <%-- <c:forEach items="${ UsersDirection }" var="p"> --%> 
                                        ...
                                        %>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
													...
													<td>
                                                <%-- <span> <%=resultSet.getString("idU") %> </span>
                                                ${p.userType} --%>
                                                <%= ut.getIdU() %>
                                                </td> 
								...
								%>  --%>
                                                  ...
                                                  <%-- <% if(resultSet.getString("typeU").equals("admin")  /* && (resultSet.getString("typeU").isEmpty() == false) */ ){
                                                ...
                                                <td>
                                                        ...
                                                        <span class="role admin"><%-- <%=resultSet.getString("typeU") %> --%>  <%= ut.getTypeU() %>  </span>
                                                   <%-- ${p.userType}  --%>    
                                                </td>
                                                
                                                  <%-- <%}else /* && (resultSet.getString("typeU").isEmpty() == false) */ {  
                                                 ...
                                                 <!-- <td> -->
                                                        ...
                                                        <span class="role user"><%=resultSet.getString("typeU") %>  <%= ut.getTypeU() %>  </span>
                                                       ${p.userType} 
                                                <!-- </td>  -->	
                                                	  <%} %>   --%>
								...
								%> --%>
                                                ...
                                                <span
													class="block-email"><%-- <%=resultSet.getString("emailU") %> --%>  <%= ut.getEmailU() %>  </span>
													<%-- ${p.email-input} --%>
                                                </td>
                                                ...
                                                <%-- <%=resultSet.getString("motDePasseU") %> 
                                                ${ p.password-input } --%>
                                                <%= ut.getMotDePasseU() %>
                                                     </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateUtilisateurForm.jsp?idU=<%= ut.getIdU() %>">
                                                        <button
                                                        ...
                                                        <a href="../JSP/deleteUtilisateur.jsp?idU=<%= ut.getIdU() %>">
                                                        <button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
