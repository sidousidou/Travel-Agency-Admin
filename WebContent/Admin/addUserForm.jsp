                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Add User
                                    </div>
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../JSP/addUtilisateur.jsp" enctype="multipart/form-data" class="form-horizontal">
                                             ...
                                             <!-- <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="userType" class="form-control-lg form-control" >
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="userType" placeholder="enter the user type" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="nameInputUser" placeholder="First and Last Name " class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="email" name="emailInputUser" placeholder="Enter Email" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" name="passwordInputUser" placeholder="Password" class="form-control">
