					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Reservation Table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addReservationForm.jsp">
								...
								<div class="table-responsive table-responsive-data1">
									<table class="table table-data2">
                                        ...
                                        <tbody>
                                        <%-- <c:forEach items="ReservationDirect" var="p"> --%>
                                        ...
                                        List reservation = sess.createQuery("From reservation").list();
                                        
                                        
                                        for(Iterator iterator = reservation.iterator(); iterator.hasNext();){
                                        ...
                                        %>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <span> <%-- ${ codeVisiteTourReservation } --%> 
                                                <%= res.getCodeVTR() %>
                                                </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <!-- <button class="item" data-toggle="tooltip" data-placement="top" title="Send">
                                                         ...
                                                         <a href="../JSP/updateReservationForm.jsp?idR=<%= res.getIdR() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                         
                                                        <a href="../JSP/deleteReservation.jsp?idR=<%= res.getIdR() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
