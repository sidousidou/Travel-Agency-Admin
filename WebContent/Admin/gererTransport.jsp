					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Transports table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addTransportForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add transport
											</button>
										</a>
								...
								<div class="table-responsive table-responsive-data2">
									<table class="table table-data2">
                                        ...
                                        List transport = sess.createQuery("From transport").list();
                                        
                                        
                                        for(Iterator iterator = transport.iterator(); iterator.hasNext();){
                                        
                                        	transport res = (transport) iterator.next();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateTransportForm.jsp?idT=<%= res.getIdT() %>"><button
                                                        ...
                                                        <a href="../JSP/deleteTransport.jsp?idT=<%= res.getIdT() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
