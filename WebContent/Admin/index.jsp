...
<meta name="author" content="Sidou">
...
<link href="Admin/vendor/mdi-font/css/material-design-iconic-font.min.css"
	rel="stylesheet" media="all">
<link href="Admin/vendor/fontawesome-free-5.10.1-web/css/all.min.css"
	rel="stylesheet" media="all">
...
<link href="Admin/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet"
	media="all">
...
<body class="animsition">
	<div class="page-wrapper">
				...
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="Admin/index.jsp"> <img
							src="Admin/images/icon/logo.png" alt="CoolAdmin" />
						</a>
					...
					<ul class="navbar-mobile__list list-unstyled">
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a href="Admin/gererUser.jsp">Client</a></li>
								<li><a href="Admin/gererUser.jsp">Admin</a></li>
							</ul></li>
						...
						<li class="has-sub">
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a href="Admin/gererHotel.jsp">Hotel</a></li>
								<li><a href="Admin/gererRestaurant.jsp">Restaurant</a></li>
								<li><a href="Admin/gererTransport.jsp">Transport</a></li>
							</ul>
						</li>
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="Admin/index.jsp"> <img src="Admin/images/icon/logo.png"
					alt="Cool Admin" />
				</a>
			</div>
									...
									<div class="noti__item js-item-menu">
										...
										<div class="email-dropdown js-dropdown">
											...
											<div class="email__item">
												...
												<div class="content">
													<p>Meeting about new Travel Agency Admin ...</p>
									...
									<div class="account-item clearfix js-item-menu">
										...
										<div class="account-dropdown js-dropdown">
											<div class="info clearfix">
												<div class="image">
													<a href="#"> <img src="Admin/images/icon/sidou.jpg"
														alt="Sidou" />
													</a>
												</div>
												<div class="content">
											...
											<div class="account-dropdown__footer">
												<a href="index.jsp"> <i class="zmdi zmdi-power"></i>Logout
												</a>
											</div>
										</div>
									</div>
									...
									<div class="au-task js-list-load">
										...
										<div class="au-task-list js-scrollbar3">
											...
											<div class="au-task__item au-task__item--warning">
												<div class="au-task__item-inner">
													<h5 class="task">
														<a href="#">Create new task for Travel Agency Admin </a>
													</h5>
