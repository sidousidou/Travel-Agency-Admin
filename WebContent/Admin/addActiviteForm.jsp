                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Basic Form</strong> For Add Activite
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="../JSP/addActivite.jsp" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="typeActivite" class=" form-control-label">Type Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="typeActivite" name="typeActivite" placeholder="type d'Activite" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer le Type d'Activite</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="descActivite" class=" form-control-label">Description Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="descActivite" name="descActivite" placeholder="Description d'Activite" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer la Description d'Activite</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="idVilleActivite" class=" form-control-label">ID Ville Activite :  </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="idVilleActivite" name="idVilleActivite" placeholder="l'ID de ville d'Activite" class="form-control">
                                                    <small class="form-text text-muted">SVP entrer l'ID de ville d'Activite</small>
                                                </div>
                                            </div>
