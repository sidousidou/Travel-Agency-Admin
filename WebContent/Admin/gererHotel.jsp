					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Hotels table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addHotelForm.jsp">
									...
									<table class="table table-data2">
										<thead>
											<tr>
												...
												<th>Classement Hotel</th>
												<th>Site Web Hotel</th>
                                        ...
                                        List hotel = sess.createQuery("From hotel").list();
                                        
                                        
                                        for(Iterator iterator = hotel.iterator(); iterator.hasNext();){
                                        
                                        	hotel h = (hotel) iterator.next();
                                        ...
                                        %>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <span> <%= h.getNbrChambreH() %> </span>
                                                </td>
                                                
                                                <td>
                                                <span> <%= h.getNumTeleH() %> </span>
                                                </td> 
                                                
                                                <td>
                                                <span> <%= h.getClassementH() %> </span>
                                                </td> 
                                                
                                                
                                                <td>
                                                <span> <%= h.getSiteWebH() %> </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateHotelForm.jsp?idH=<%= h.getIdH() %>"><button
                                                        ...
                                                        <a href="../JSP/deleteHotel.jsp?idH=<%= h.getIdH() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
