					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Circuits table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addCircuitForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add circuit
											</button>
										</a>
									...
									<table class="table table-data2">
										<thead>
											<tr>
												...
												<th>Code Circuit</th>
												<th>Duree Circuit</th>
												<th>Villes Circuit</th>
												<th>ID User Circuit</th>
												<th>ID Ville Circuit</th>
                                        ...
                                        List circuit = sess.createQuery("From circuit").list();
                                        
                                        
                                        for(Iterator iterator = circuit.iterator(); iterator.hasNext();){
                                        
                                        	circuit h = (circuit) iterator.next();
                                        ...
                                        %>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <span><%= h.getVillesC() %></span>
                                                </td>
                                                
                                                <td>
                                                <span> <%= h.getIdUserC() %> </span>
                                                </td> 
                                                
                                                
                                                <td>
                                                <span> <%= h.getIdVilleC() %> </span>
                                                </td> 
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updateCircuitForm.jsp?codeC=<%= h.getCodeC() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Edit">
                                                            <i
																class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="../JSP/deleteCircuit.jsp?codeC=<%= h.getCodeC() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
