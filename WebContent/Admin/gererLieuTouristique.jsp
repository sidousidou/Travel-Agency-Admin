...
<!-- Title Page-->
<title>Gerer Lieu Touristique</title>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">Lieux Touristiques table</h3>
								<div class="table-data__tool">
									...
									<div class="table-data__tool-right">
										...
										<a class="addVoyageBtn" href="addLieuTouristiqueForm.jsp">
											<button class="au-btn au-btn-icon au-btn--green au-btn--small">
												<i class="zmdi zmdi-plus" ></i>add lieu touristique
											</button>
										</a>
									...
									<table class="table table-data2">
										<thead>
											<tr>
												...
												<th>Id Lieu Touristique</th>
												<th>Type Lieu Touristique</th>
												<th>Description Lieu Touristique</th>
												<th>Nom Lieu Touristique</th>
												<th>Adresse Lieu Touristique</th>
												<th>ID Ville Lieu Touristique</th>
                                        ...
                                        List lieutouristique = sess.createQuery("From lieutouristique").list();
                                        
                                        
                                        for(Iterator iterator = lieutouristique.iterator(); iterator.hasNext();){
                                        
                                        	lieutouristique res = (lieutouristique) iterator.next();
                                        ...
                                        %>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <span><%= res.getDescriptionLT() %></span>
                                                </td>
                                                
                                                <td>
                                                <span> <%= res.getNomLT() %> </span>
                                                </td> 
                                                
                                                <td>
                                                <span> <%= res.getAdresseLT() %>  </span>
                                                </td> 
                                                
                                                
                                                <td>
                                                <span> <%= res.getIdVilleLT() %> </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="../JSP/updatelieutouristiqueForm.jsp?idLT=<%= res.getIdLT() %>"><button
                                                        ...
                                                        <a href="../JSP/deletelieutouristique.jsp?idLT=<%= res.getIdLT() %>"><button
															class="item" data-toggle="tooltip" data-placement="top"
															title="Delete">
                                                            <i
