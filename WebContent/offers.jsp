					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="news.jsp">News</a></li>
				...
				<div class="col">
					<div class="items item_grid clearfix">
						...
						<div class="item clearfix rating_5">
							<div class="item_image"><img src="images/beach-clouds-dawn-262325.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From 8000 Dz</div>
								<div class="item_title">Bejaia, Algeria</div>
								<ul>
									<li>1 person</li>
									<li>1 nights</li>
									<li>5 star hotel</li>
								...
								<div class="item_more_link"><a href="reserver.jsp"><h3>Reserve</h3></a></div>
							</div>
						</div>

						<!-- Item -->
						<div class="item clearfix rating_3">
							<div class="item_image"><img src="images/high-landscape-majestic-1183021.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From 3500 DZ</div>
								<div class="item_title">Jijel ,Algeria</div>
								<ul>
									<li>1 person</li>
									<li>1 nights</li>
									<li>3 star hotel</li>
						...
						<div class="item clearfix rating_4">
							<div class="item_image"><img src="images/82713980-constantine-algerie-7-mars-2017-la-falaise-de-près-du-pont-suspendu-ou-de-la-passerelle-de-sidi-mcid-l.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From 6000 DZ</div>
								<div class="item_title">Constantine ,Algeia</div>
								<ul>
									<li>1 person</li>
									<li>1 nights</li>
									<li>4 star hotel</li>
                          ...
                          <!-- Item -->
                          <div class="item clearfix rating_4">
							<div class="item_image"><img src="images/7f8dab091d6fb628187acf210fa2592f.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From 5000 DZ</div>
								<div class="item_title">Djanet ,Algeia</div>
								<ul>
									<li>1 person</li>
									<li>1 nights</li>
									<li>4 star hotel</li>
						...
						<!-- Item -->
						<div class="item clearfix rating_5">
							<div class="item_image"><img src="images/arizona-clouds-dawn-248174.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From 4000 dz</div>
								<div class="item_title">Tamanrasset, Algeria</div>
								<ul>
									<li>1 person</li>
									<li>1 nights</li>
									<li>5 star hotel</li>
